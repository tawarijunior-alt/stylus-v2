        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
          ...
          <tr>
            <td style="background:#0a0a0a;border-left:1px solid #222;border-right:1px solid #222;padding:40px;text-align:center;border-bottom:1px solid #222">
              <div style="width:60px;height:60px;border:2px solid #c9a84c;border-radius:50%;margin:0 auto 20px;line-height:60px;color:#c9a84c;font-size:24px">✓</div>
          ...
          <tr>
            <td style="background:#0a0a0a;border-left:1px solid #222;border-right:1px solid #222;padding:30px 40px;border-bottom:1px solid #222">
              ...
              <p style="font-size:14px;color:#888;margin:0;line-height:1.8">${address.street}<br>${address.city}, ${address.state}<br>${address.country}</p>
            </td>
          </tr>
          <tr>
            <td style="background:#0a0a0a;border-left:1px solid #222;border-right:1px solid #222;padding:30px 40px;border-bottom:1px solid #222;text-align:center">
              <p style="font-size:13px;color:#888;margin:0 0 15px;line-height:1.6">Questions about your order? We are here.</p>
              <a href="https://wa.me/${process.env.WHATSAPP_NUMBER}?text=Hi+STYLUS+my+order+ref+is+${reference}" style="display:inline-block;padding:12px 30px;background:#25d366;color:#000;font-family:'Courier New',monospace;font-size:11px;letter-spacing:0.15em;text-transform:uppercase;text-decoration:none;font-weight:700">Chat on WhatsApp</a>
            </td>
          </tr>
          <tr>
...
<body style="margin:0;padding:0;background:#000;font-family:'Helvetica Neue',sans-serif">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#000;padding:40px 20px">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
          <tr>
            <td style="background:#0a0a0a;border:1px solid #222;padding:40px;text-align:center">
              <div style="font-family:'Courier New',monospace;font-size:28px;font-weight:700;letter-spacing:0.3em;color:#c9a84c">STYLUS</div>
              <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:0.3em;color:#555;margin-top:6px;text-transform:uppercase">Premium Clothing</div>
              <div style="margin:30px 0;width:60px;height:1px;background:#c9a84c;margin-left:auto;margin-right:auto"></div>
              <h1 style="font-family:Georgia,serif;font-size:28px;font-weight:300;color:#fff;margin:0 0 15px;font-style:italic">Welcome, ${name}.</h1>
              <p style="font-size:14px;color:#888;line-height:1.8;margin:0 0 25px">You are now part of the STYLUS family. Elevated essentials for those who move with intention.</p>
              <p style="font-family:'Courier New',monospace;font-size:12px;color:#c9a84c;letter-spacing:0.1em;margin:0 0 25px">Use code <strong>WELCOME10</strong> for 10% off your first order</p>
              <a href="${process.env.STORE_URL}" style="display:inline-block;padding:14px 35px;background:#fff;color:#000;font-family:'Courier New',monospace;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;text-decoration:none;font-weight:700">Shop Now</a>
            </td>
          </tr>
        </table>
      </td>
